    ...
    switch (commandIndex) {
      ...
      case 1:
        {
          AlertDialogWidget().showCupertinoDialog(context,
            ...
            // 明文返回数据
            tradeData.sign = '10000004';
            tradeData.cash = '1200';
            if ((cash != '') && (cash != null)) {
              tradeData.cash = cash;
            }
            tradeData.encryptionAlgorithm = '010000000240';
      ...
      case 27:
        //PIN Encryption
        {
          ...
          // 010000000000 有ksn
          // 020100000000 无ksn
          itronBle.terminalEncryptionPIN('', '123456', '010000000000',
              (pin, ksn, status) {
            String str = '';
            if (status == 0) {
              ...
              str =
                  'terminalEncryptionPIN fail,please swip card first,error code:' +
                      status.toRadixString(16);
            } else {
              str = 'terminalEncryptionPIN fail,error code:' +
                  status.toRadixString(16);
            }
            setState(() {
              textStr = str;
